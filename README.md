...
> Admitted to **Epitech** and currently training at **Holberton School** — actively looking for an **alternance** in **System Administration** or **Development** (starting September 2026).

---

## About Me

I'm a motivated tech student with a strong interest in how systems work — from infrastructure and networking to web applications. I'm building hands-on experience in both **system administration** (Linux, networking, scripting) and **web development** (HTML, CSS, JavaScript), while also deepening my understanding of cybersecurity.
...
**Alternance — System Administration or Development**
Available: **September 2026** | Based in **Caussade (82)** — open to travel | Duration: flexible
...
- Python — scripting, automation, OOP
...
*Web & Full-Stack Development — Project-based curriculum*
