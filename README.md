...
- **Metasploit** — exploitation framework (rare badge, top 9.6%)
- **SQLMap** — SQL injection testing (rare badge, top 6.5%)
- **EternalBlue / MS17-010** — Windows exploitation via SMB
- Network security fundamentals
- Web application security (HTTP, how the web works)
...
**[alternance-agents](https://github.com/lucasmettetal/alternance-agents)**  
Local prospecting tool to find IT companies likely to hire apprentices around Caussade, Montauban and Toulouse. Queries the French government company API, scores each result with a deterministic algorithm + a local **LLM (Ollama / llama3.2)**, enriches data via web scraping (LinkedIn, website, email), and exposes everything through a **Streamlit** interface with status tracking and email generation. Stack: **Python**, **LiteLLM**, **Streamlit**, `recherche-entreprises.api.gouv.fr`.
...
Custom Unix shell written in **C** — handles command parsing, process forking, execution, and built-in commands. A deep dive into how shells actually work.

**[holbertonschool-printf](https://github.com/lucasmettetal/holbertonschool-printf)**  
Custom reimplementation of `printf` in **C** — covers variadic functions, format specifiers, and low-level output handling.

**[appli-muscu](https://github.com/lucasmettetal/appli-muscu)**  
Personal fitness tracking web app built with **React + TypeScript + Vite + Tailwind CSS**. Includes a REST API integration and is deployed on Vercel.
...
**[Project_web_security](https://github.com/lucasmettetal/Project_web_security)**  
Web security fundamentals: explored common vulnerabilities and attack surfaces as part of a structured security curriculum.

**THCon — Toulouse Hacking Convention (CTF participant)**  
Participated in the **THCon CTF**, an international cybersecurity competition held in Toulouse (Paul Sabatier University / ENSEEIHT). Competed in challenges covering web exploitation, cryptography, and binary exploitation.

**TryHackMe — [lucas.mettetal](https://tryhackme.com/p/lucas.mettetal)**  
Rank **[0x8] HACKER** — **top 6%** worldwide | **71 rooms** completed | **84-day streak**  
13 badges earned including rare/epic: Metasploitable (9.6%), Sword Apprentice/SQLMap (6.5%), Silver League 1st place (2.2%), Chaos Reigns (0.4% — Epic).

[![TryHackMe](https://tryhackme-badges.s3.amazonaws.com/lucas.mettetal.png)](https://tryhackme.com/p/lucas.mettetal)

---

## Education

**Epitech** *(admitted — starting September 2026)*  
...
- Collaborative development (peer reviews, pair programming)

---

## Contact

[![LinkedIn](https://img.shields.io/badge/LinkedIn-Lucas%20Mettetal-0A66C2?style=flat&logo=linkedin)](https://www.linkedin.com/in/lucas-mettetal-a079a8388/)
[![GitHub](https://img.shields.io/badge/GitHub-lucasmettetal-181717?style=flat&logo=github)](https://github.com/lucasmettetal)
[![TryHackMe](https://img.shields.io/badge/TryHackMe-Top%206%25%20%7C%20Hacker-212C42?style=flat&logo=tryhackme&logoColor=white)](https://tryhackme.com/p/lucas.mettetal)

---

![Lucas's GitHub Stats](https://github-readme-stats.vercel.app/api?username=lucasmettetal&show_icons=true&theme=default&hide_border=true)
